            ...
            <div class="p-6 md:p-8">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                        <p class="text-white font-semibold">Amount: ₱{{ $amount > 0 ? number_format($amount, 2) : '0.00' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-6 md:p-8">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-6 mb-8">
                    ...
                    <form action="{{ route('donor.donations.cash.update-amount', ['method' => 'gcash']) }}" method="POST" class="mb-4">
                        @csrf
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-6 mb-8">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            ...
                            <span class="font-medium">{{ now()->format('M d, Y - h:i A') }}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Recipient Name:</span>
                            <span class="font-medium">{{ config('payment_accounts.gcash.name') }}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">GCash Number:</span>
                            <span class="font-mono font-medium">{{ config('payment_accounts.gcash.number') }}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                ...
                <!-- Pay Now Button -->
                <div class="mb-8">
                    <a href="{{ route('donor.donations.cash.gateway', ['method' => 'gcash']) }}" 
                        ...
                        <div class="flex justify-center">
                            <div class="relative bg-gradient-to-br from-blue-100 to-indigo-100 p-6 rounded-2xl border-2 border-dashed border-blue-300 shadow-lg">
                                ...
                                <img src="{{ $qrCodeUrl }}" 
                                     ...
                                     onerror="this.onerror=null; this.src='{{ asset('images/placeholder-qr.png') }}';">
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 mt-6">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div class="bg-white px-6 py-3 rounded-lg font-mono text-lg font-bold border border-gray-200">
                                {{ config('payment_accounts.gcash.number') }}
                            </div>
                            <button type="button" 
                                    onclick="copyToClipboard('{{ config('payment_accounts.gcash.number') }}')" 
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <ol class="list-decimal list-inside text-blue-700 space-y-2">
                                ...
                                <li>Enter the amount: <span class="font-bold">₱{{ number_format($amount, 2) }}</span></li>
                ...
                <!-- Payment Form -->
                <form action="{{ route('donor.donations.cash.process', ['method' => 'gcash']) }}" method="POST">
                    @csrf
