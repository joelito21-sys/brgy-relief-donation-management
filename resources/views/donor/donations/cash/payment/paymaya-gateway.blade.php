    ...
    <div class="max-w-md mx-auto">
            ...
            <div class="bg-white shadow-sm p-6 mb-4">
                ...
                <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 mb-6">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-4xl font-bold text-green-600">₱{{ number_format($amount, 2) }}</p>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between py-3 border-b">
                        ...
                        <span class="font-semibold text-gray-800">{{ config('payment_accounts.paymaya.name') }}</span>
                    </div>
                    <div class="flex items-center justify-between py-3 border-b">
                        <div class="flex items-center">
                        ...
                        <span class="font-mono font-semibold text-gray-800">{{ config('payment_accounts.paymaya.number') }}</span>
                    </div>
                    <div class="flex items-center justify-between py-3 border-b">
                        <div class="flex items-center">
        ...
        <div id="step4" class="hidden">
            <div class="bg-white shadow-sm p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-lg text-gray-800">₱{{ number_format($amount, 2) }}</p>
                            </div>
                        </div>
                ...
                <form id="completeForm" action="{{ route('donor.donations.cash.process', ['method' => 'paymaya']) }}" method="POST">
                    @csrf
    ...
    <script>
        ...
        function goBack() {
            if (confirm('Are you sure you want to cancel this payment?')) {
                window.location.href = '{{ route('donor.donations.cash.payment', ['method' => 'paymaya']) }}';
            }
        }
