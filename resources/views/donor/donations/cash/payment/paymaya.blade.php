    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-6 md:p-8">
                ...
                <div class="bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-100 rounded-xl p-6 mb-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between py-3 font-bold text-lg">
                            ...
                            <span class="text-purple-600" id="summary_total_amount">₱{{ number_format($amount, 2) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Pay Now Button -->
                <div class="mb-8">
                    <a href="{{ route('donor.donations.cash.gateway', ['method' => 'paymaya']) }}" 
                       id="pay_now_btn"
                    ...
                    <div class="text-center mb-6">
                        ...
                        <div class="flex justify-center">
                            <div class="relative bg-gradient-to-br from-purple-100 to-indigo-100 p-6 rounded-2xl border-2 border-dashed border-purple-300 shadow-lg">
                                <img src="{{ asset('images/qr-codes/paymaya-qr.png') }}" alt="PayMaya QR Code" class="h-64 w-64 mx-auto object-contain rounded-xl shadow-md">
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 mt-6">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div class="bg-white px-6 py-3 rounded-lg font-mono text-lg font-bold border border-gray-200">
                                {{ config('payment_accounts.paymaya.number') }}
                            </div>
                            <button type="button" 
                                    onclick="copyToClipboard('{{ config('payment_accounts.paymaya.number') }}')"
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <ol class="list-decimal list-inside text-purple-700 space-y-2">
                                ...
                                <li>Enter the amount: <span class="font-bold" id="instruction_amount">₱{{ number_format($amount, 2) }}</span></li>
                ...
                <!-- Payment Form -->
                <form action="{{ route('donor.donations.cash.process', ['method' => 'paymaya']) }}" method="POST">
                    @csrf
