...
@section('title', 'Choose Donation Type - Barangay Cubacub Relief and Donation Management Program')

@section('header', 'Choose Donation Type')
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="card h-100 border-0 shadow-sm hover-shadow transition-all duration-300">
                        <div class="card-body d-flex flex-column text-center p-4">
                            ...
                            <a href="{{ route('donor.donations.food.index') }}" 
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="card h-100 border-0 shadow-sm hover-shadow transition-all duration-300">
                        <div class="card-body d-flex flex-column text-center p-4">
                            ...
                            <a href="{{ route('donor.donations.clothing.index') }}" 
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="card h-100 border-0 shadow-sm hover-shadow transition-all duration-300">
                        <div class="card-body d-flex flex-column text-center p-4">
                            ...
                            <a href="{{ route('donor.donations.medicine.index') }}" 
