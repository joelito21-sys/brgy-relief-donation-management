        ...
        <div class="col-lg-8">
            ...
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('donor.donations.index') }}" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                <div class="card-body p-0">
                                ...
                                <tbody>
                                    @foreach($recentDonations as $donation)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('donor.donations.show', $donation->id) }}" class="btn btn-sm btn-link p-0">
                    ...
                    @else
                        <div class="text-center p-5">
                            ...
                            <a href="{{ route('donor.donations.index') }}" class="btn btn-primary mt-2">
