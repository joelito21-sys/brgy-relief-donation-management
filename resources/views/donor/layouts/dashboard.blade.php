{{-- resources/views/donor/layouts/dashboard.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('donor.dashboard') }}" class="sidebar-logo">
        ...
        <div class="sidebar-menu">
            <a href="{{ route('donor.dashboard') }}" class="nav-link {{ request()->routeIs('donor.dashboard') ? 'active' : '' }}">
                <i class="fas fa-home"></i>
                <span>Dashboard</span>
            </a>
            
            <a href="{{ route('donor.donations.index') }}" class="nav-link {{ request()->routeIs('donor.donations.*') ? 'active' : '' }}">
                <i class="fas fa-hand-holding-heart"></i>
                <span>My Donations</span>
            </a>
            
            <a href="{{ route('donor.donations.history') }}" class="nav-link {{ request()->routeIs('donor.donations.history') ? 'active' : '' }}">
                <i class="fas fa-history"></i>
                <span>Donation History</span>
            </a>
            
            <a href="{{ route('donor.activities') }}" class="nav-link {{ request()->routeIs('donor.activities') ? 'active' : '' }}">
                <i class="fas fa-calendar-alt"></i>
                <span>Activities</span>
            </a>

            <a href="{{ route('donor.messages.index') }}" class="nav-link {{ request()->routeIs('donor.messages.*') ? 'active' : '' }}">
                <i class="fas fa-comment-alt"></i>
                <span>Messages</span>
            </a>
            
            <a href="{{ route('donor.settings') }}" class="nav-link {{ request()->routeIs('donor.settings') ? 'active' : '' }}">
            ...
            <a href="{{ route('donor.about') }}" class="nav-link {{ request()->routeIs('donor.about') ? 'active' : '' }}">
                <i class="fas fa-info-circle"></i>
                <span>About Us</span>
            </a>
            
            <a href="{{ route('donor.contact') }}" class="nav-link {{ request()->routeIs('donor.contact') ? 'active' : '' }}">
                ...
                <div class="d-flex align-items-center mb-2">
                    <div class="me-2">
                        <div class="rounded-circle bg-white text-dark d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;">
                            {{ strtoupper(substr(Auth::guard('donor')->user()->name, 0, 1)) }}
                        </div>
                    </div>
                    <div>
                        <div class="fw-bold text-white">{{ Auth::guard('donor')->user()->name }}</div>
                        <div>Donor</div>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            ...
            <div class="mx-auto text-center">
                <h1 class="h4 mb-0 text-white">@yield('header', 'Dashboard')</h1>
                <div class="text-white-50 small">
                    Welcome back, {{ Auth::guard('donor')->user()->name }}! 👋
                ...
                <div class="dropdown">
                    <button class="btn btn-link text-decoration-none dropdown-toggle d-flex align-items-center" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="me-2 d-none d-md-block text-end">
                            <div class="fw-medium text-white">{{ Auth::guard('donor')->user()->name }}</div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        <li><a class="dropdown-item" href="{{ route('donor.profile') }}"><i class="fas fa-user me-2"></i>Profile</a></li>
            ...
            <div class="container-fluid">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="mb-3 mb-md-0">
                        <span class="text-muted">&copy; {{ date('Y') }} Barangay Cubacub Relief and Donation Management Program. All rights reserved.</span>
                    </div>
                    <div class="d-flex">
