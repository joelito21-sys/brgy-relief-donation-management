...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-green-50 to-emerald-50">
    ...
    <!-- Main Content -->
        ...
        <div class="py-16 bg-gradient-to-r from-green-50 to-emerald-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                ...
                <!-- Stats Section -->
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-16">
                    <!-- Total Donations -->
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="text-3xl font-bold text-gray-900 mb-2">₱{{ number_format($totalDonations, 2) }}</div>
                        <div class="text-gray-600 font-medium">Total Donations</div>
                        <p class="text-xs text-gray-500 mt-2">Collective generosity of our community</p>
                    </div>

                    <!-- People Helped -->
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        <div class="flex items-center justify-between mb-4">
                            <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-3">
                                <i class="fas fa-users text-white text-2xl"></i>
                            </div>
                        </div>
                        <div class="text-3xl font-bold text-gray-900 mb-2">{{ number_format($peopleHelped) }}+</div>
                        <div class="text-gray-600 font-medium">People Helped</div>
                        <p class="text-xs text-gray-500 mt-2">Families receiving assistance</p>
                    </div>

                    <!-- Total Donors -->
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        <div class="flex items-center justify-between mb-4">
                            <div class="bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl p-3">
                                <i class="fas fa-hand-holding-heart text-teal text-white text-2xl"></i>
                            </div>
                        </div>
                        <div class="text-3xl font-bold text-gray-900 mb-2">{{ number_format($totalDonors) }}</div>
                        <div class="text-gray-600 font-medium">Total Donors</div>
                        <p class="text-xs text-gray-500 mt-2">Generous supporters</p>
                    </div>

                    <!-- Relief Operations -->
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        <div class="flex items-center justify-between mb-4">
                            <div class="bg-gradient-to-br from-lime-500 to-lime-600 rounded-xl p-3">
                                <i class="fas fa-box-open text-white text-2xl"></i>
                            </div>
                        </div>
                        <div class="text-3xl font-bold text-gray-900 mb-2">{{ number_format($completedReliefRequests) }}</div>
                        <div class="text-gray-600 font-medium">Relief Operations</div>
                        <p class="text-xs text-gray-500 mt-2">Completed missions</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="gallery-item bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="h-64 overflow-hidden">
                            <img src="{{ asset('images/flood.jpeg') }}" alt="Feeding Program - People receiving food assistance" class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                    ...
                    <div class="gallery-item bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="h-64 overflow-hidden">
                            <img src="{{ asset('images/rescue.jpeg') }}" alt="Relief Distribution - Volunteers distributing aid supplies" class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                    ...
                    <div class="gallery-item bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="h-64 overflow-hidden">
                            <img src="{{ asset('images/landslide.jpeg') }}" alt="Shelter Support - Temporary housing for displaced families" class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                    ...
                    <div class="gallery-item bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="h-64 overflow-hidden">
                            <img src="{{ asset('images/OIP (1).jpg') }}" alt="Medical Aid - Healthcare workers assisting flood victims" class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                    ...
                    <div class="gallery-item bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="h-64 overflow-hidden">
                            <img src="{{ asset('images/OIP (2).jpg') }}" alt="Education Support - Children continuing their studies" class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                    ...
                    <div class="gallery-item bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="h-64 overflow-hidden">
                            <img src="{{ asset('images/OIP (3).jpg') }}" alt="Community Rebuilding - Volunteers rebuilding infrastructure" class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                ...
                <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="team-member p-6 bg-white rounded-lg shadow-md text-center">
                        <div class="w-32 h-32 mx-auto rounded-full bg-gray-200 mb-4 overflow-hidden">
                            <img src="{{ asset('images/592182972_712817481477107_1983668944099758967_n.jpg') }}" alt="Sarah Johnson" class="w-full h-full object-cover transition-transform duration-300">
                        </div>
                    ...
                    <div class="team-member p-6 bg-white rounded-lg shadow-md text-center">
                        <div class="w-32 h-32 mx-auto rounded-full bg-gray-200 mb-4 overflow-hidden">
                            <img src="{{ asset('images/594452902_1369848030647551_3647686060341469210_n.jpg') }}" alt="Michael Chen" class="w-full h-full object-cover transition-transform duration-300">
                        </div>
                    ...
                    <div class="team-member p-6 bg-white rounded-lg shadow-md text-center">
                        <div class="w-32 h-32 mx-auto rounded-full bg-gray-200 mb-4 overflow-hidden">
                            <img src="{{ asset('images/598182351_1779457496095731_6690650627272076342_n.jpg') }}" alt="David Rodriguez" class="w-full h-full object-cover transition-transform duration-300">
                        </div>
                    ...
                    <div class="team-member p-6 bg-green rounded-lg shadow-md text-center">
                        <div class="w-32 h-32 mx-auto rounded-full bg-gray-200 mb-4 overflow-hidden">
                            <img src="{{ asset('images/Screenshot 2025-12-13 213524.png') }}" alt="Team Member" class="w-full h-full object-cover transition-transform duration-300">
                        </div>
                ...
                <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul class="mt-4 space-y-4">
                                <li>
                                    <a href="{{ route('home') }}" class="text-base text-gray-400 hover:text-white">
                                        Home
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('about') }}" class="text-base text-gray-400 hover:text-white">
                                        About Us
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul class="mt-4 space-y-4">
                                <li>
                                    <a href="{{ route('donor.register') }}" class="text-base text-gray-400 hover:text-white">
                                        Become a Donor
                                    </a>
                                </li>
