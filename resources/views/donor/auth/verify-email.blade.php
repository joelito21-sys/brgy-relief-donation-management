...
@section('title', 'Verify Email - Donor Portal')
            ...
            <div class="p-6">
                ...
                <div class="text-center mb-6">
                    ...
                    <div class="bg-green-50 rounded-lg p-3 mb-4">
                        <p class="font-medium text-green-700 break-all">{{ $donor->email }}</p>
                    </div>
                ...
                <!-- OTP Form -->
                <form action="{{ route('donor.verification.verify') }}" method="POST">
                    @csrf
                    <div class="mb-6">
                ...
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <div class="text-center">
                        ...
                        <form action="{{ route('donor.verification.resend') }}" method="POST" class="inline">
                            @csrf
                ...
                <div class="mt-4 text-center">
                    <small class="text-gray-500">
                        Wrong email address? 
                        <a href="{{ route('donor.register') }}" class="text-green-600 hover:text-green-800 font-medium">
                            Register again
                        </a>
                    </small>
                </div>
