...
<head>
    ...
    <title>Donor Registration - {{ config('app.name', 'Barangay Cubacub Relief and Donation Management Program') }}</title>
...
<div class="w-full max-w-md mx-auto text-white">
    ...
    <div class="px-8 py-10 glass-effect rounded-2xl shadow-2xl border border-white/20 animate-slide-up">
        ...
        <div class="text-center mb-8 animate-fade-in">
            <div class="flex justify-center mb-4">
                <div class="relative">
                    ...
                    <img src="{{ asset('images/logo.png') }}" alt="Flood Relief Logo" class="relative h-12 w-auto">
                </div>
            </div>
        ...
        <!-- Registration Form -->
        <form class="space-y-6" method="POST" action="{{ route('donor.register') }}" id="donorForm">
            @csrf
            ...
            <div class="animate-slide-up" style="animation-delay: 0.1s;">
                ...
                <div class="relative group">
                    ...
                    <input id="name" name="name" type="text" required
                           ...
                           placeholder="Enter your full name" value="{{ old('name') }}" autocomplete="name" autofocus>
            ...
            <div class="animate-slide-up" style="animation-delay: 0.3s;">
                ...
                <div class="relative group">
                    ...
                    <!-- value="{{ old('phone') }}" is removed to rely on JS setting "09" or re-setting old value logically -->
                    <input id="phone" name="phone" type="tel" required maxlength="11"
                           class="form-input pl-10 group-hover:bg-white/15 transition-all" 
                           placeholder="09123456789" value="{{ old('phone', '09') }}">
                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center opacity-0 group-hover:opacity-100 transition-opacity">
                        <i class="fas fa-check-circle text-green-400 text-sm"></i>
                    </div>
                </div>
            ...
            <div class="flex items-start animate-slide-up" style="animation-delay: 0.6s;">
                ...
                <label for="terms" class="ml-2 block text-sm text-white/80 cursor-pointer hover:text-white transition-colors">
                    I agree to the <a href="{{ route('terms') }}" class="text-indigo-400 hover:text-indigo-300 transition-colors">Terms of Service</a> and 
                    <a href="{{ route('privacy') }}" class="text-indigo-400 hover:text-indigo-300 transition-colors">Privacy Policy</a>
                </label>
            </div>
            @error('terms')
                <p class="mt-1 text-sm text-red-400 animate-slide-up">{{ $message }}</p>
        ...
        <div class="mt-6 text-center animate-slide-up" style="animation-delay: 0.9s;">
            <a href="{{ route('donor.login') }}" class="font-medium text-indigo-400 hover:text-indigo-300 transition-colors group">
