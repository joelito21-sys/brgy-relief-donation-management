...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('donor.password.email') }}">
            @csrf
            ...
            <div class="text-center">
                <a href="{{ route('donor.login') }}" class="font-medium text-indigo-600 hover:text-indigo-500">
                    {{ __('Back to login') }}
                </a>
            </div>
        </form>
