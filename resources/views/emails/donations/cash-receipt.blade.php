...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We are incredibly grateful for your cash donation of <strong>₱{{ number_format($donation->amount, 2) }}</strong>. Your generosity will make a significant difference in providing relief to families affected by the floods.</p>
            
            <div class="receipt">
                <h2>📋 Donation Receipt</h2>
                <p><strong>Receipt #:</strong> {{ $donation->reference_number }}</p>
                ...
                @if($donation->payment_method === 'bank')
                    <p><strong>Bank:</strong> {{ $donation->details['bank_name'] ?? 'N/A' }}</p>
                    <p><strong>Sender Name:</strong> {{ $donation->details['sender_name'] ?? 'N/A' }}</p>
                @endif
            </div>
            ...
            <p><a href="{{ route('donor.dashboard') }}">Track Your Impact</a></p>
        ...
        <div class="footer">
            ...
            <p>This is an automated receipt for your cash donation. Reference #: {{ $donation->reference_number }}</p>
        </div>
    </div>
</body>
</html>
