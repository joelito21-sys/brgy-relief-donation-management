...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">PayMaya Account</h1>
            <p class="mt-2 text-sm text-gray-600">View and manage PayMaya donations</p>
        </div>
    ...
    <div class="card">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">PayMaya Donations</h2>
        </div>
        <div class="p-6">
