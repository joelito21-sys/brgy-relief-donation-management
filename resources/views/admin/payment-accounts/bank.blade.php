...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-600">View and manage bank transfer donations</p>
        </div>
    ...
    <div class="card">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Bank Transfer Donations</h2>
        </div>
        <div class="p-6">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">
                                    No bank transfer donations found
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
