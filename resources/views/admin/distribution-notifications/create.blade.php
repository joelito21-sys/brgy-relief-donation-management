...
@section('title', 'Create Distribution Notification')
        ...
        <div class="col-lg-10 col-xl-9">
            <div class="form-card mt-4 mb-4">
                ...
                <div class="p-4">
                    ...
                    <form action="{{ route('admin.distribution-notifications.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control form-control-modern @error('title') is-invalid @enderror" 
                                       value="{{ old('title') }}" placeholder="e.g., Emergency Food Distribution - Barangay Cubacub" required>
                            ...
                            <div>
                                ...
                                <textarea name="message" rows="3" class="form-control form-control-modern @error('message') is-invalid @enderror" 
                                          placeholder="Enter the main message for residents..." required>{{ old('message') }}</textarea>
                        ...
                        <div class="form-section">
                            ...
                            <div class="type-selector">
                                <label class="type-card" id="type-general">
                                    <input type="radio" name="distribution_type" value="general" {{ old('distribution_type', 'general') == 'general' ? 'checked' : '' }} style="display: none;">
                                ...
                                <label class="type-card" id="type-specific">
                                    <input type="radio" name="distribution_type" value="specific" {{ old('distribution_type') == 'specific' ? 'checked' : '' }} style="display: none;">
                            ...
                            <div id="general-fields" class="mt-3">
                                ...
                                <select name="target_area" id="target_area" class="form-control form-control-modern" onchange="updateResidentCount()">
                                    <option value="" data-count="{{ $totalApprovedResidents }}">All Approved Residents ({{ $totalApprovedResidents }} residents)</option>
                                    @for($i = 1; $i <= 10; $i++)
                                        @php $purokName = "Purok $i"; $count = $purokCounts[$purokName] ?? 0; @endphp
                                        <option value="{{ $purokName }}" data-count="{{ $count }}" {{ old('target_area') == $purokName ? 'selected' : '' }}>
                                            {{ $purokName }} ({{ $count }} residents)
                                        </option>
                                    @endfor
                                </select>
                                ...
                                <div id="resident-count-box" class="mt-3 p-3 rounded-lg" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                    <div class="d-flex align-items-center text-white">
                                        ...
                                        <div>
                                            ...
                                            <div class="h3 mb-0" id="count-number">{{ $totalApprovedResidents }}</div>
                            ...
                            <div id="specific-fields" class="mt-3" style="display: none;">
                                ...
                                <select name="relief_request_id" class="form-control form-control-modern">
                                    ...
                                    @forelse($reliefRequests as $request)
                                        <option value="{{ $request->id }}">#{{ $request->id }} - {{ $request->full_name }}</option>
                                    @empty
                        ...
                        <div class="form-section">
                            ...
                            <div class="location-grid">
                                <div>
                                    ...
                                    <input type="text" name="location" class="form-control form-control-modern @error('location') is-invalid @enderror" 
                                           value="{{ old('location') }}" placeholder="e.g., Barangay Hall" required>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="scheduled_date" id="scheduled_date" 
                                           class="form-control form-control-modern @error('scheduled_date') is-invalid @enderror" 
                                           value="{{ old('scheduled_date', now()->addDay()->format('Y-m-d\TH:i')) }}" required>
                        ...
                        <div class="form-section">
                            ...
                            <textarea name="additional_info" rows="2" class="form-control form-control-modern" 
                                      placeholder="Extra notes (items to bring, requirements, etc.)">{{ old('additional_info') }}</textarea>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <label class="toggle-switch">
                                ...
                                <input type="checkbox" name="send_immediately" class="toggle-input" value="1" {{ old('send_immediately') ? 'checked' : '' }}>
                            </label>
                        </div>
                        ...
                        <div class="action-buttons">
                            ...
                            <a href="{{ route('admin.distribution-notifications.index') }}" class="btn btn-cancel">
