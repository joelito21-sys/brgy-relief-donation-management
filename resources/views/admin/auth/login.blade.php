        ...
        <div class="text-center">
            <div class="flex flex-col items-center">
                <div class="p-4 bg-white rounded-full shadow-md mb-4">
                    <img src="{{ asset('images/logo.png') }}" alt="{{ config('app.name', 'Barangay Cubacub Relief and Donation Management Program') }}" class="h-32 w-auto">
                </div>
                <h1 class="text-2xl header-text">{{ config('app.name', 'Barangay Cubacub Relief and Donation Management Program') }}</h1>
        ...
        <form method="POST" action="{{ route('admin.login') }}" class="mt-8 space-y-6">
            ...
            <div class="flex items-center">
                <input id="remember-me" name="remember" type="checkbox"
                       class="h-4 w-4 text-violet-600 focus:ring-violet-500 border-gray-300 rounded" {{ old('remember') ? 'checked' : '' }}>
