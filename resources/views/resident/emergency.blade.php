...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            @if(Auth::guard('resident')->user()->emergency_contact_name)
                <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-gray-900">{{ Auth::guard('resident')->user()->emergency_contact_name }}</p>
                                <p class="text-sm text-gray-600">Emergency Contact</p>
                            </div>
                        </div>
                        <a href="tel:{{ Auth::guard('resident')->user()->emergency_contact_phone }}" 
                           class="inline-flex items-center px-4 py-2 border border-purple-300 text-sm font-medium rounded text-purple-700 bg-purple-50 hover:bg-purple-100">
                            ...
                            {{ Auth::guard('resident')->user()->emergency_contact_phone }}
                        </a>
                    </div>
                </div>
            @else
                <div class="text-center py-8">
                    ...
                    <a href="{{ route('resident.profile.edit') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
