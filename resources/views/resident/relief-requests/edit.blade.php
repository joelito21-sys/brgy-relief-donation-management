            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-8 animate-fade-in">
                    ...
                    <p class="text-xl text-white/90 max-w-2xl mx-auto">
                       Update the details of your relief request #{{ $reliefRequest->id }}.
                    </p>
                </div>

                <!-- Main Content -->
                <div class="glass-effect rounded-2xl shadow-2xl p-8">
                    <form action="{{ route('resident.relief-requests.update', $reliefRequest->id) }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="bg-white rounded-xl p-6 border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" 
                                           name="full_name" 
                                           value="{{ old('full_name', $reliefRequest->full_name) }}"
                                           required
                                ...
                                <div>
                                    ...
                                    <input type="tel" 
                                           name="contact_number"
                                           value="{{ old('contact_number', $reliefRequest->contact_number) }}"
                                           required
                                           class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="email" 
                                           name="email_address"
                                           value="{{ old('email_address', $reliefRequest->email_address) }}"
                                           required
                                           class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           name="id_number"
                                           value="{{ old('id_number', $reliefRequest->id_number) }}"
                                           required
                                           class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('complete_address', $reliefRequest->complete_address) }}"
                                           required
                                           class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <select name="city_municipality"
                                            required
                                            class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        <option value="Mandaue City" {{ old('city_municipality', $reliefRequest->city_municipality) == 'Mandaue City' ? 'selected' : '' }}>Mandaue City</option>
                                        <option value="Consolacion" {{ old('city_municipality', $reliefRequest->city_municipality) == 'Consolacion' ? 'selected' : '' }}>Consolacion</option>
                                        <option value="Cebu City" {{ old('city_municipality', $reliefRequest->city_municipality) == 'Cebu City' ? 'selected' : '' }}>Cebu City</option>
                                        <option value="Lapu-Lapu City" {{ old('city_municipality', $reliefRequest->city_municipality) == 'Lapu-Lapu City' ? 'selected' : '' }}>Lapu-Lapu City</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="province"
                                            required
                                            class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        <option value="Cebu" {{ old('province', $reliefRequest->province) == 'Cebu' ? 'selected' : '' }}>Cebu</option>
                                        <option value="Bohol" {{ old('province', $reliefRequest->province) == 'Bohol' ? 'selected' : '' }}>Bohol</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="postal_code"
                                            class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        <option value="6014" {{ old('postal_code', $reliefRequest->postal_code) == '6014' ? 'selected' : '' }}>6014</option>
                                        <option value="6000" {{ old('postal_code', $reliefRequest->postal_code) == '6000' ? 'selected' : '' }}>6000</option>
                                        <option value="6001" {{ old('postal_code', $reliefRequest->postal_code) == '6001' ? 'selected' : '' }}>6001</option>
                                        <option value="6015" {{ old('postal_code', $reliefRequest->postal_code) == '6015' ? 'selected' : '' }}>6015</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           name="household_size"
                                           value="{{ old('household_size', $reliefRequest->household_size) }}"
                                           min="1"
                                           required
                                           class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <label class="relative cursor-pointer">
                                            <input type="radio" name="urgency_level" value="low" class="peer sr-only" required {{ old('urgency_level', $reliefRequest->urgency_level) == 'low' ? 'checked' : '' }}>
                                        ...
                                        <label class="relative cursor-pointer">
                                            <input type="radio" name="urgency_level" value="medium" class="peer sr-only" {{ old('urgency_level', $reliefRequest->urgency_level) == 'medium' ? 'checked' : '' }}>
                                        ...
                                        <label class="relative cursor-pointer">
                                            <input type="radio" name="urgency_level" value="high" class="peer sr-only" {{ old('urgency_level', $reliefRequest->urgency_level) == 'high' ? 'checked' : '' }}>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="col-span-1">
                                            <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer w-full">
                                                <input type="checkbox" name="assistance_types[]" value="cash" class="mr-3" id="cash_checkbox" onchange="toggleCashAmount()" {{ $hasCash ? 'checked' : '' }}>
                                                <i class="fas fa-dollar-sign text-blue-600 mr-2"></i>
                                                <span>Cash</span>
                                            </label>
                                            <div id="cash_amount_container" class="{{ $hasCash ? '' : 'hidden' }} mt-2">
                                                <select name="cash_amount" 
                                                    ...
                                                    <option value="" disabled {{ !$hasCash ? 'selected' : '' }}>Select amount</option>
                                                    @for ($i = 1000; $i <= 10000; $i += 500)
                                                        <option value="{{ $i }}" {{ $cashAmount == $i ? 'selected' : '' }}>₱{{ number_format($i) }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer">
                                            <input type="checkbox" name="assistance_types[]" value="food" class="mr-3" {{ in_array('food', $assistanceTypes) ? 'checked' : '' }}>
                                            <i class="fas fa-utensils text-blue-600 mr-2"></i>
                                            <span>Food Supplies</span>
                                        </label>

                                        <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer">
                                            <input type="checkbox" name="assistance_types[]" value="water" class="mr-3" {{ in_array('water', $assistanceTypes) ? 'checked' : '' }}>
                                            <i class="fas fa-tint text-blue-600 mr-2"></i>
                                            <span>Clean Water</span>
                                        </label>

                                        <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer">
                                            <input type="checkbox" name="assistance_types[]" value="medicine" class="mr-3" {{ in_array('medicine', $assistanceTypes) ? 'checked' : '' }}>
                                            <i class="fas fa-pills text-blue-600 mr-2"></i>
                                            <span>Medicine</span>
                                        </label>

                                        <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer">
                                            <input type="checkbox" name="assistance_types[]" value="clothing" class="mr-3" {{ in_array('clothing', $assistanceTypes) ? 'checked' : '' }}>
                                            <i class="fas fa-tshirt text-blue-600 mr-2"></i>
                                            <span>Clothing</span>
                                        </label>

                                        <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer">
                                            <input type="checkbox" name="assistance_types[]" value="shelter" class="mr-3" {{ in_array('shelter', $assistanceTypes) ? 'checked' : '' }}>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" 
                                              ...
                                              required
                                              class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                              placeholder="Please provide detailed information about your situation and specific needs...">{{ old('description', $reliefRequest->description) }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div>
                                            ...
                                            <input type="number" name="children_count" min="0" value="{{ old('children_count', $reliefRequest->children_count) }}"
                                                   class="form-input w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-600 mb-1">Elderly (60+)</label>
                                            <input type="number" name="elderly_count" min="0" value="{{ old('elderly_count', $reliefRequest->elderly_count) }}"
                                                   class="form-input w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-600 mb-1">Persons with Disability</label>
                                            <input type="number" name="pwd_count" min="0" value="{{ old('pwd_count', $reliefRequest->pwd_count) }}"
                                                   class="form-input w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-600 mb-1">Pregnant Women</label>
                                            <input type="number" name="pregnant_count" min="0" value="{{ old('pregnant_count', $reliefRequest->pregnant_count) }}"
                                                   class="form-input w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea name="additional_message" 
                                              rows="3"
                                              class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                              placeholder="Any additional information or special requirements...">{{ old('additional_message', $reliefRequest->additional_message) }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <input type="text" 
                                               ...
                                               value="{{ old('emergency_contact_name', $reliefRequest->emergency_contact_name) }}"
                                               class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                               placeholder="Contact person name">
                                        <input type="tel" 
                                               name="emergency_contact_phone"
                                               value="{{ old('emergency_contact_phone', $reliefRequest->emergency_contact_phone) }}"
                                               class="form-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
