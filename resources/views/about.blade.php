        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-24">
                <div class="flex items-center space-x-3">
                    <img src="{{ asset('images/logo.png') }}" alt="Barangay Cubacub Logo" class="h-20 w-auto">
                    <a href="{{ route('home') }}" class="text-2xl font-bold text-white">Barangay Cubacub Relief and Donation Management Program</a>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('home') }}" class="text-white hover:text-green-200 px-3 py-2 rounded-md text-sm font-medium">Home</a>
                    <a href="/about" class="bg-green-700 text-white px-3 py-2 rounded-md text-sm font-medium">About Us</a>
                    @auth('donor')
                       
                    @else
                        <a href="{{ route('donor.login') }}" class="text-white hover:text-green-200 px-3 py-2 rounded-md text-sm font-medium">Donor Login</a>
                        <a href="{{ route('donor.register') }}" class="bg-white text-green-600 px-4 py-2 rounded-md text-sm font-medium hover:bg-green-50">Register</a>
                    @endauth
                </div>
            </div>
        </div>
