    ...
    <div class="max-w-md mx-auto">
            ...
            <div class="bg-white shadow-sm p-6 mb-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center py-3 border-b">
                        ...
                        <span class="font-semibold text-gray-800"><?php echo e(config('payment_accounts.gcash.name')); ?></span>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b">
                        <span class="text-gray-600">GCash Number</span>
                        <span class="font-mono font-semibold text-gray-800"><?php echo e(config('payment_accounts.gcash.number')); ?></span>
                    </div>
                    <div class="flex justify-between items-center py-3">
                        <span class="text-gray-600">Amount</span>
                        <span class="text-3xl font-bold text-blue-600">₱<?php echo e(number_format($amount, 2)); ?></span>
                    </div>
                </div>
            </div>
        ...
        <div id="step4" class="hidden">
            <div class="bg-white shadow-sm p-8">
                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-bold text-lg text-gray-800">₱<?php echo e(number_format($amount, 2)); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Recipient</span>
                ...
                <form id="completeForm" action="<?php echo e(route('donor.donations.cash.process', ['method' => 'gcash'])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function goBack() {
            if (confirm('Are you sure you want to cancel this payment?')) {
                window.location.href = '<?php echo e(route('donor.donations.cash.payment', ['method' => 'gcash'])); ?>';
            }
        }
...
<?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/donor/donations/cash/payment/gcash-gateway.blade.php ENDPATH**/ ?>