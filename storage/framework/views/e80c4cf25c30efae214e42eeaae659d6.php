...
<?php $__env->startSection('title', 'GCash Account'); ?>
        ...
        <div class="card">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-bold text-gray-900"><?php echo e($approvedCount); ?></div>
        ...
        <div class="card">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-bold text-gray-900"><?php echo e($donations->count()); ?></div>
                            ...
                            <tr>
                                        ...
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div class="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                                                <span class="text-blue-600 font-medium text-sm">
                                                    <?php echo e(substr($donation->donor_name, 0, 1)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        <?php echo e($donation->reference_number ?? 'N/A'); ?>

                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                        <?php echo e($donation->status === 'approved' ? 'bg-green-100 text-green-800' : 
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/admin/payment-accounts/gcash.blade.php ENDPATH**/ ?>