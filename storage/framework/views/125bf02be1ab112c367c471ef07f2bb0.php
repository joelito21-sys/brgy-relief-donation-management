<?php $__env->startSection('title', 'Donor Management'); ?>
    ...
    <div class="stat-card bg-gradient-to-r from-violet-500 to-violet-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['total'] ?? 0); ?></p>
            </div>
    ...
    <div class="stat-card bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['active'] ?? 0); ?></p>
            </div>
            <div class="bg-black rounded-lg p-3">
    ...
    <div class="stat-card bg-gradient-to-r from-amber-500 to-amber-600 rounded-xl p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['donations'] ?? 0); ?></p>
            </div>
    ...
    <div class="stat-card bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['this_month'] ?? 0); ?></p>
            </div>
            <div class="bg-white/20 rounded-lg p-3">
    ...
    <div class="border-b border-gray-200 p-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a href="<?php echo e(route('admin.donors.create')); ?>" 
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10">
                                <?php if($donor->profile_photo_path): ?>
                                    <img class="h-10 w-10 rounded-full object-cover" 
                                         src="<?php echo e(Storage::url($donor->profile_photo_path)); ?>" 
                                         alt="<?php echo e($donor->name); ?>">
                                <?php else: ?>
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-bold text-black"><?php echo e($donor->name); ?></div>
                                <div class="text-sm text-black">Joined: <?php echo e($donor->created_at->format('M d, Y')); ?></div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center text-black">
                            ...
                            <span class="font-bold"><?php echo e($donor->email); ?></span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center text-black">
                            <i class="fas fa-phone text-gray-400 mr-2 text-sm"></i>
                            <span class="font-bold"><?php echo e($donor->phone ?? 'N/A'); ?></span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-violet-100 text-black">
                                ...
                                <?php echo e($donor->donations_count ?? 0); ?> Donations
                            </span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-2">
                            <a href="<?php echo e(route('admin.donors.show', $donor)); ?>" 
                            ...
                            <form method="POST" action="<?php echo e(route('admin.donors.toggle-status', $donor)); ?>" class="inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                                <button type="submit" 
                                        class="action-btn inline-flex items-center px-3 py-1.5 <?php echo e($donor->is_active ? 'bg-red-100 text-black hover:bg-red-200' : 'bg-green-100 text-black hover:bg-green-200'); ?> rounded-lg text-sm font-bold">
                                    <i class="fas fa-<?php echo e($donor->is_active ? 'ban' : 'check'); ?> mr-1"></i>
                                    <?php echo e($donor->is_active ? 'Deactivate' : 'Activate'); ?>
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <a href="<?php echo e(route('admin.donors.create')); ?>" class="mt-4 px-4 py-2 bg-violet-600 text-white rounded-lg hover:bg-violet-700 transition-colors font-bold">
    ...
    <div class="border-t border-gray-200 px-6 py-4">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="text-sm text-black font-bold">
                Showing <span class="font-bold"><?php echo e($donors->firstItem()); ?></span> to 
                <span class="font-bold"><?php echo e($donors->lastItem()); ?></span> of 
                <span class="font-bold"><?php echo e($donors->total()); ?></span> entries
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/admin/donors/index.blade.php ENDPATH**/ ?>