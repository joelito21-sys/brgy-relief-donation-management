            ...
            <nav class="flex mt-1 text-sm text-gray-500 rounded-lg bg-gray-50 px-2 py-1 w-fit" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="<?php echo e(route('admin.contact-messages.index')); ?>" class="inline-flex items-center text-gray-700 hover:text-blue-600">
                            Contact Messages
                        </a>
                    </li>
                    <li>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-6">
                <div class="p-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                    <h2 class="font-bold text-gray-800 flex items-center">
                        <i class="fas fa-envelope-open-text mr-2 text-violet-600"></i> Message from <?php echo e($contactMessage->name); ?>
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="text-gray-900"><?php echo e($contactMessage->name); ?></div>
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-1">Email</label>
                            <div class="text-gray-900">
                                <a href="mailto:<?php echo e($contactMessage->email); ?>" class="text-blue-600 hover:underline"><?php echo e($contactMessage->email); ?></a>
                            </div>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-bold text-gray-700 mb-1">Subject</label>
                            <div class="text-gray-900 font-medium"><?php echo e($contactMessage->subject); ?></div>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-bold text-gray-700 mb-1">Date Received</label>
                            <div class="text-gray-900 text-sm"><?php echo e($contactMessage->created_at->format('F d, Y h:i A')); ?></div>
                        </div>
                    </div>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <?php if($contactMessage->status == 'pending'): ?>
                        <form action="<?php echo e(route('admin.contact-messages.reply', $contactMessage)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-red-200 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('admin.contact-messages.destroy', $contactMessage)); ?>" method="POST" onsubmit="return confirm('This action cannot be undone. Are you sure?');">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/admin/contact_messages/show.blade.php ENDPATH**/ ?>