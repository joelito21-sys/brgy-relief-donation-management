...
<?php $__env->startSection('title', 'Create Relief Request'); ?>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="glass-effect rounded-2xl shadow-2xl p-8">
                    <form action="<?php echo e(route('resident.relief-requests.store')); ?>" method="POST" class="space-y-8">
                        <?php echo csrf_field(); ?>
                                            ...
                                            <div id="cash_amount_container" class="hidden mt-2">
                                                <select name="cash_amount" 
                                                    ...
                                                    <?php for($i = 1000; $i <= 10000; $i += 500): ?>
                                                        <option value="<?php echo e($i); ?>">₱<?php echo e(number_format($i)); ?></option>
                                                    <?php endfor; ?>
                                                </select>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.resident', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/resident/relief-requests/create.blade.php ENDPATH**/ ?>