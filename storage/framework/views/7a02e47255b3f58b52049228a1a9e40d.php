...
<head>
    ...
    <title>Account Verification - <?php echo e(config('app.name')); ?></title>
...
<body class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 mb-6">
                ...
                <?php if(auth()->guard('resident')->user()): ?>
                    <div class="bg-white/20 rounded-lg p-4">
                        ...
                        <div class="text-left text-indigo-100 text-sm space-y-1">
                            ...
                            ?>
                            <p><strong>Name:</strong> <?php echo e($displayName); ?></p>
                            <p><strong>Email:</strong> <?php echo e($resident->email); ?></p>
                            <p><strong>Submitted:</strong> <?php echo e($resident->created_at->format('M d, Y - h:i A')); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="space-y-4">
                ...
                <form action="<?php echo e(route('resident.logout')); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        <?php if(auth()->guard('resident')->user() && auth()->guard('resident')->user()->isApproved()): ?>
            window.location.href = "<?php echo e(route('resident.dashboard')); ?>";
        <?php endif; ?>
    </script>
</body>
</html><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/resident/auth/verification.blade.php ENDPATH**/ ?>