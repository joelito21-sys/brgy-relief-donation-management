        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-24">
                <div class="flex items-center space-x-3">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="text-lg font-bold text-white hover:text-green-100 transition">Barangay Cubacub Relief</a>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('home')); ?>" class="text-white hover:bg-green-700 px-3 py-2 rounded-md text-sm font-medium transition">Home</a>
                    <a href="<?php echo e(route('about')); ?>" class="text-white hover:bg-green-700 px-3 py-2 rounded-md text-sm font-medium transition">About Us</a>
                    <a href="<?php echo e(route('contact')); ?>" class="bg-white text-green-700 font-bold px-3 py-2 rounded-md text-sm transition shadow-sm">Contact</a>
                </div>
            </div>
        </div>
    </nav>
                    ...
                    <div class="mt-10">
                         <div class="w-full h-48 rounded-lg overflow-hidden border border-white/10">
                            <a href="https://www.google.com/maps?q=Barangay+Cubacub+Hall,+Mandaue+City,+Cebu" target="_blank" rel="noopener noreferrer" class="block h-full w-full">
                                <img src="<?php echo e(asset('images/static_map.png')); ?>" alt="Map Location" class="w-full h-full object-cover transform hover:scale-105 transition duration-500">
                            </a>
                         </div>
                    </div>
                </div>
    ...
    <footer class="bg-gray-800 border-t border-gray-700 mt-auto">
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-center">
            <p class="text-base text-gray-400">
                &copy; <?php echo e(date('Y')); ?> Barangay Cubacub Relief Management. All rights reserved.
            </p>
        </div>
    </footer>
</body>
</html>
<?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/contact.blade.php ENDPATH**/ ?>