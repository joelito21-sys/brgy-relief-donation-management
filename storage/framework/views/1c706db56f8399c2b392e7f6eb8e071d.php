...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg">
            ...
            <!-- Form -->
            <form class="p-6" method="POST" action="<?php echo e(route('resident.profile.update')); ?>">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="shrink-0">
                            <img class="h-20 w-20 object-cover rounded-full" 
                                 src="<?php echo e(Auth::guard('resident')->user()->profile_photo_url); ?>" 
                                 alt="Profile photo">
                        </div>
                        <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" 
                               value="<?php echo e(Auth::guard('resident')->user()->name); ?>"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" 
                               value="<?php echo e(Auth::guard('resident')->user()->email); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone" 
                               value="<?php echo e(Auth::guard('resident')->user()->phone); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="id_number" name="id_number" 
                               value="<?php echo e(Auth::guard('resident')->user()->id_number); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" id="address" name="address" 
                               value="<?php echo e(Auth::guard('resident')->user()->address); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="barangay" name="barangay" 
                               value="<?php echo e(Auth::guard('resident')->user()->barangay); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="city" name="city" 
                               value="<?php echo e(Auth::guard('resident')->user()->city); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="province" name="province" 
                               value="<?php echo e(Auth::guard('resident')->user()->province); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="postal_code" name="postal_code" 
                               value="<?php echo e(Auth::guard('resident')->user()->postal_code); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="emergency_contact_name" name="emergency_contact_name" 
                               value="<?php echo e(Auth::guard('resident')->user()->emergency_contact_name); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" id="emergency_contact_phone" name="emergency_contact_phone" 
                               value="<?php echo e(Auth::guard('resident')->user()->emergency_contact_phone); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="family_size" name="family_size" min="1" max="50"
                               value="<?php echo e(Auth::guard('resident')->user()->family_size); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="special_needs" name="special_needs" rows="3"
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(Auth::guard('resident')->user()->special_needs ? implode(', ', json_decode(Auth::guard('resident')->user()->special_needs, true) ?? []) : ''); ?></textarea>
...
<?php echo $__env->make('layouts.resident', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/resident/profile/edit.blade.php ENDPATH**/ ?>