...
<head>
    ...
    <title>Donor Portal - <?php echo e(config('app.name', 'Barangay Cubacub Relief and Donation Management Program')); ?></title>
    ...
    <div class="px-8 py-10 glass-effect rounded-2xl shadow-2xl border border-white/20 animate-slide-up">
        ...
        <div class="text-center mb-8 animate-fade-in">
            <div class="flex justify-center mb-4">
                <div class="relative">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Flood Relief Logo" class="relative h-24 w-auto">
                </div>
            </div>
        ...
        <!-- Login Form -->
        <form class="space-y-6" action="<?php echo e(route('donor.login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="animate-slide-up" style="animation-delay: 0.2s;">
                <div class="flex items-center justify-between mb-1">
                    ...
                    <a href="<?php echo e(route('donor.password.request')); ?>" class="text-xs text-white/70 hover:text-white transition-colors group">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-6 text-center animate-slide-up" style="animation-delay: 0.8s;">
            <p class="text-sm text-white/80">
                ...
                <a href="<?php echo e(route('donor.register')); ?>" class="font-medium text-indigo-400 hover:text-indigo-300 transition-colors group">
                    Create an account
...
<?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/donor/auth/login.blade.php ENDPATH**/ ?>