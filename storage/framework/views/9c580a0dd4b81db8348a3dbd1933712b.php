    ...
    <div class="stat-card bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($notificationSettings ?? 3); ?></p>
            </div>
            <div class="bg-white/20 rounded-lg p-3">
    ...
    <div class="stat-card bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($lastUpdated ?? 'Today'); ?></p>
            </div>
            <div class="bg-white/20 rounded-lg p-3">
...
<div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl border border-violet-200">
    ...
    <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" enctype="multipart/form-data" class="p-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="site_name" 
                           name="site[name]" 
                           value="<?php echo e(old('site.name', $settings['site']['name'] ?? 'Flood Control System')); ?>"
                ...
                <div>
                    ...
                    <input type="email" 
                           id="site_email" 
                           name="site[email]" 
                           value="<?php echo e(old('site.email', $settings['site']['email'] ?? 'admin@floodcontrol.com')); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-colors text-black"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="site_description" 
                              ...
                              rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-colors text-black"
                              placeholder="Describe your flood control system"><?php echo e(old('site.description', $settings['site']['description'] ?? 'Comprehensive flood management and relief distribution system')); ?></textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <select id="timezone" 
                        ...
                        <?php $__currentLoopData = $timezones ?? ['Asia/Manila', 'Asia/Tokyo', 'Asia/Singapore', 'UTC', 'America/New_York', 'Europe/London']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timezone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($timezone); ?>" <?php echo e(($settings['site']['timezone'] ?? 'Asia/Manila') === $timezone ? 'selected' : ''); ?>>
                                <?php echo e($timezone); ?>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" 
                               ...
                               value="1" 
                               <?php echo e(old('notifications.email_enabled', $settings['notifications']['email_enabled'] ?? true) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" 
                               ...
                               value="1" 
                               <?php echo e(old('notifications.sms_enabled', $settings['notifications']['sms_enabled'] ?? false) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" 
                               ...
                               value="1" 
                               <?php echo e(old('notifications.push_enabled', $settings['notifications']['push_enabled'] ?? true) ? 'checked' : ''); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" 
                               ...
                               value="1" 
                               <?php echo e(old('backup.auto_enabled', $settings['backup']['auto_enabled'] ?? true) ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <select id="backup_schedule" 
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-colors text-black">
                        <option value="daily" <?php echo e(old('backup.schedule', $settings['backup']['schedule'] ?? 'daily') === 'daily' ? 'selected' : ''); ?>>Daily</option>
                        <option value="weekly" <?php echo e(old('backup.schedule', $settings['backup']['schedule'] ?? 'daily') === 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                        <option value="monthly" <?php echo e(old('backup.schedule', $settings['backup']['schedule'] ?? 'daily') === 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="<?php echo e(old('backup.retention_days', $settings['backup']['retention_days'] ?? 30)); ?>"
                           min="1"
                           max="365"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-colors text-black"
                           placeholder="30">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>