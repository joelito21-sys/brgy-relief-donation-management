...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" method="POST" action="<?php echo e(route('resident.password.otp.send')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="text-center">
                <a href="<?php echo e(route('resident.login')); ?>" class="font-medium text-indigo-600 hover:text-indigo-500">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/resident/auth/passwords/otp-request.blade.php ENDPATH**/ ?>