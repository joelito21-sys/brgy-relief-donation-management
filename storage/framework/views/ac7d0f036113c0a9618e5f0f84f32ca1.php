...
<head>
    ...
    <title>Resident Login - <?php echo e(config('app.name')); ?></title>
    <!-- Scripts -->
    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            <div class="mx-auto flex justify-center">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="<?php echo e(config('app.name')); ?>" class="h-20 w-auto">
            </div>
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('resident.login.process')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-lg shadow-xl p-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="<?php echo e(route('resident.password.request')); ?>" class="font-medium text-indigo-600 hover:text-indigo-500">
        ...
        <div class="text-center">
            <p class="text-blue-700">
                ...
                <a href="<?php echo e(route('resident.register')); ?>" class="font-medium text-blue-900 hover:text-blue-800">
                    Register here
                </a>
            </p>
        </div>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('home')); ?>" class="text-blue-700 hover:text-blue-900 text-sm">
                <i class="fas fa-arrow-left mr-2"></i>Back to Home
            </a>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/resident/auth/login.blade.php ENDPATH**/ ?>