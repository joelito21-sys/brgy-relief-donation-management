...
<head>
    ...
    <title><?php echo e(config('app.name', 'Barangay Cubacub Relief and Donation Management Program')); ?> - Donor Dashboard</title>
        ...
        <aside style="background-color: #22c55e;" class="w-64 shadow-xl fixed left-0 top-0 h-full z-30 transform transition-all duration-300 ease-in-out" id="sidebar">
            ...
            <div class="p-4 border-b border-white/20">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 user-profile-text">
                        <p class="font-semibold text-white"><?php echo e(Auth::guard('donor')->user()->name); ?></p>
                        <p class="text-sm text-white/80"><?php echo e(Auth::guard('donor')->user()->email); ?></p>
                    </div>
                </div>
            </div>
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="<?php echo e(route('donor.dashboard')); ?>" 
                   class="sidebar-item flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('donor.dashboard') ? 'active' : 'text-white'); ?>">
                    <i class="fas fa-tachometer-alt w-5"></i>
                    <span class="font-medium">Dashboard</span>
                </a>

                <!-- Donate -->
                <a href="<?php echo e(route('donor.donations.index')); ?>" 
                   class="sidebar-item flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('donor.donations.index') ? 'active' : 'text-white'); ?>">
                ...
                <a href="<?php echo e(route('donor.donations.history')); ?>" 
                   class="sidebar-item flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('donor.donations.history') ? 'active' : 'text-white'); ?>">
                    <i class="fas fa-history w-5"></i>
                    <span class="font-medium">Donation History</span>
                </a>

                <!-- Activities -->
                <a href="<?php echo e(route('donor.activities')); ?>" 
                   class="sidebar-item flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('donor.activities') ? 'active' : 'text-white'); ?>">
                ...
                <a href="<?php echo e(route('donor.profile')); ?>" 
                   class="sidebar-item flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('donor.profile.*') ? 'active' : 'text-white'); ?>">
                    <i class="fas fa-user-circle w-5"></i>
                    <span class="font-medium">My Profile</span>
                </a>

                <!-- Settings -->
                <a href="<?php echo e(route('donor.settings')); ?>" 
                   class="sidebar-item flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('donor.settings') ? 'active' : 'text-white'); ?>">
                    <i class="fas fa-cog w-5"></i>
                    <span class="font-medium">Settings</span>
                </a>

                <!-- Help/Support -->
                <a href="<?php echo e(route('donor.contact')); ?>" 
                   class="sidebar-item flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('donor.contact') ? 'active' : 'text-white'); ?>">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-white/20">
                <form method="POST" action="<?php echo e(route('donor.logout')); ?>" class="w-full">
                    <?php echo csrf_field(); ?>
                    <button type="submit" 
                        ...
                        <div class="relative">
                            <button onclick="toggleUserMenu()" 
                                ...
                                <span class="text-white font-medium hidden md:block">
                                    <?php echo e(Auth::guard('donor')->user()->name); ?>
                            ...
                            <div id="userMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                <a href="<?php echo e(route('donor.profile')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                                    <i class="fas fa-user-circle mr-2"></i>Profile
                                </a>
                                <a href="<?php echo e(route('donor.settings')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
...
<?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/layouts/donor.blade.php ENDPATH**/ ?>