...
<head>
    ...
    <title>Resident Registration - <?php echo e(config('app.name')); ?></title>
    <!-- Scripts -->
    ...
    <div class="max-w-4xl w-full space-y-8">
        ...
        <div class="sticky-header">
            <div class="mx-auto flex justify-center">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="<?php echo e(config('app.name')); ?>" class="h-16 w-auto">
            </div>
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('resident.register.process')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="suffix" name="suffix"
                            ...
                            <option value="V" <?php echo e(old('suffix') == 'V' ? 'selected' : ''); ?>>V</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <select id="id_type" name="id_type" required
                            ...
                            <option value="" disabled <?php echo e(old('id_type') ? '' : 'selected'); ?>>Select ID type</option>
                            <option value="National ID" <?php echo e(old('id_type') == 'National ID' ? 'selected' : ''); ?>>National ID</option>
                            <option value="Passport" <?php echo e(old('id_type') == 'Passport' ? 'selected' : ''); ?>>Passport</option>
                            <option value="Driver's License" <?php echo e(old('id_type') == "Driver's License" ? 'selected' : ''); ?>>Driver's License</option>
                            <option value="Postal ID" <?php echo e(old('id_type') == 'Postal ID' ? 'selected' : ''); ?>>Postal ID</option>
                        </select>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="mt-3 bg-red-100 border border-red-400 text-red-700 p-4 rounded-lg">
                                ...
                                <p class="mt-1 text-sm"><?php echo e($message); ?></p>
                            </div>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input id="subdivision" name="subdivision" type="text"
                            ...
                            value="<?php echo e(old('subdivision')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="hidden" id="final_address" name="address" value="<?php echo e(old('address')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-2">
                        ...
                        <?php $__errorArgs = ['family_member_names'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center">
            <p class="text-indigo-100">
                ...
                <a href="<?php echo e(route('resident.login')); ?>" class="font-medium text-white hover:text-indigo-200">
                    Sign in here
                </a>
            </p>
        </div>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('home')); ?>" class="text-indigo-100 hover:text-white text-sm">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const oldBarangay = "<?php echo e(old('barangay')); ?>";
            ...
            const oldAddress = "<?php echo e(old('address')); ?>";
            ...
            <?php if(old('family_member_names')): ?>
                <?php $__currentLoopData = old('family_member_names', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    (function() {
                        const entry = createFamilyMemberEntry(<?php echo e($index); ?>);
                        entry.querySelector('input[name="family_member_names[]"]').value = "<?php echo e($name); ?>";
                        entry.querySelector('select[name="family_member_relationships[]"]').value = "<?php echo e(old('family_member_relationships')[$index] ?? ''); ?>";
                        entry.querySelector('input[name="family_member_ages[]"]').value = "<?php echo e(old('family_member_ages')[$index] ?? ''); ?>";
                        familyMembersContainer.appendChild(entry);
                        familyMemberIndex++;
                    })();
...
</html><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/resident/auth/register.blade.php ENDPATH**/ ?>