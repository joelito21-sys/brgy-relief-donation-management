...
<?php $__env->startSection('title', 'Resident Management'); ?>
    ...
    <div class="stat-card bg-gradient-to-r from-violet-500 to-violet-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['total']); ?></p>
            </div>
    ...
    <div class="stat-card bg-gradient-to-r from-amber-500 to-amber-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['pending']); ?></p>
            </div>
            <div class="bg-white rounded-lg p-3">
    ...
    <div class="stat-card bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['approved']); ?></p>
            </div>
            <div class="bg-white rounded-lg p-3">
    ...
    <div class="stat-card bg-gradient-to-r from-red-500 to-red-600 rounded-xl p-6 text-black">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2 text-black"><?php echo e($stats['rejected']); ?></p>
            </div>
    ...
    <div class="border-b border-gray-200 p-6" style="background: linear-gradient(135deg, #8B5CF6 0%, #7C3AED 100%);">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <form method="GET" action="<?php echo e(route('admin.residents.index')); ?>" class="flex gap-3">
                    <div class="relative">
                ...
                <a href="<?php echo e(route('admin.residents.create')); ?>" 
        ...
        <table class="w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        <input type="checkbox" name="resident_ids[]" value="<?php echo e($resident->id); ?>" 
                               class="resident-checkbox rounded border-gray-300 text-violet-600 focus:ring-violet-500" 
                               <?php echo e(!$resident->isPending() ? 'disabled' : ''); ?>>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <div class="w-8 h-8 bg-violet-100 rounded-full flex items-center justify-center mr-3">
                                <span class="text-violet-600 font-medium text-sm"><?php echo e(substr($resident->first_name, 0, 1)); ?><?php echo e(substr($resident->last_name, 0, 1)); ?></span>
                            </div>
                            <div>
                                <a href="<?php echo e(route('admin.residents.show', $resident)); ?>" class="font-bold text-black hover:text-violet-600">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-black">
                            ...
                            <?php echo e($resident->house_number); ?>, <?php echo e($resident->address); ?>

                            <?php if($resident->subdivision): ?> <br>(<?php echo e($resident->subdivision); ?>) <?php endif; ?>
                            <br>
                            <?php echo e($resident->barangay); ?>, <?php echo e($resident->city); ?>, <?php echo e($resident->province); ?>, <?php echo e($resident->country); ?>
                    ...
                    <td class="px-6 py-4 text-black">
                        <?php echo e($resident->created_at->format('M d, Y')); ?>

                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-2">
                            <a href="<?php echo e(route('admin.residents.show', $resident)); ?>" 
                            ...
                            <?php if($resident->isPending()): ?>
                                <form method="POST" action="<?php echo e(route('admin.residents.approve', $resident)); ?>" class="inline" onsubmit="return confirm('Approve this resident?')">
                                    <?php echo csrf_field(); ?>
                                ...
                                <button type="button" onclick="showRejectModal(<?php echo e($resident->id); ?>)" 
                ...
                <tr>
                    <td colspan="8" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <a href="<?php echo e(route('admin.residents.create')); ?>" class="mt-4 px-4 py-2 bg-violet-600 text-white rounded-lg hover:bg-violet-700 transition-colors font-bold">
    ...
    <div class="border-t border-gray-200 px-6 py-4">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="text-sm text-black font-bold">
                Showing <span class="font-bold"><?php echo e($residents->firstItem()); ?></span> to 
                <span class="font-bold"><?php echo e($residents->lastItem()); ?></span> of 
                <span class="font-bold"><?php echo e($residents->total()); ?></span> entries
            </div>
...
<form method="POST" action="<?php echo e(route('admin.residents.bulk.approve')); ?>" id="bulkApproveForm" class="hidden">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="resident_ids" id="bulkApproveIds">
</form>
<form method="POST" action="<?php echo e(route('admin.residents.bulk.reject')); ?>" id="bulkRejectForm" class="hidden">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\flood_control - Copy\ghost\resources\views/admin/residents/index.blade.php ENDPATH**/ ?>